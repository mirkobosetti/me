...
export const projectsDetailData: Record<string, ProjectDetail> = {
  ...
  'portfolio-website': {
    ...
    features: [
      ...
      'Doto pixel display type paired with JetBrains Mono for legibility',
      'Self-healing scroll reveals that respect reduced-motion',
      'Structured data (JSON-LD) and Open Graph metadata',
      'Fully responsive, dark-locked terminal design system'
    ],
    links: {
